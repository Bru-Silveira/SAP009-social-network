...
const logo = "data:image/png;base64,";
const headerInitial = () => {
...
const register = async (name2, email, password) => {
...
const logoGithub = "/assets/github.63582760.png";
const footer = () => {
...
<div id="div-footer">
  ...
  <div class="git-name">
    <img src="${logoGithub}" alt="cat icon" class="github-cat"><a href="https://github.com/marinacezario" class="footer-names">Marina Cez\xE1rio</a>
  </div>
  <div class="git-name">
...
const logoComplete = "/assets/logo-s2s-transparent.eda23f5b.png";
const location = "/assets/location-dot-solid.1e27a6b3.png";
const pen = "/assets/pen-to-square-regular.5d0fff96.png";
const heartFull = "/assets/heart-solid.49777fe0.png";
const home = () => {
...
<div class="home-main">
  ...
  <div class="home-initial-text">
    ...
    <br>
    <h2>A melhor rede social para aprender Ingl\xEAs!</h2>
    <br>
  </div>
  <div class="main-content-home">
    <div class="icons-text-home">
      <img src="${location}" alt="Location dot icon" class="icons-home">
      <p class="text-home">Estudantes de todo o pa\xEDs se encontram aqui.</p>
    </div>
    <div class="icons-text-home">
      <img src="${logo}" alt="Logo s2s three people icon" class="icons-home">
      <p class="text-home">Pratique ingl\xEAs com outros estudantes do idioma.</p>
    </div>
    <div class="icons-text-home">
    ...
    <div class="icons-text-home">
      <img src="${heartFull}" alt="Love icon"  class="icons-home">
      <p class="text-home">Curta conte\xFAdos de outras pessoas e fa\xE7a amizades.</p>
    </div>
  </div>
</div>
<div id="button-home">  
...
const logoGoogle = "/assets/google-37.cb0f52e7.png";
const login = () => {
...
<form class="form-login" action="">
  ...
  loginBtn.addEventListener("click", (e) => {
    ...
    loginToFeed(emailLogin.value, passwordLogin.value).then(() => {
  ...
  resetPasswordBtn.addEventListener("click", () => {
    resetPassword(emailLogin.value).then(() => {
...
`;
  ...
  const name2 = signupContainer.querySelector("#name");
  ...
  registerBtn.addEventListener("click", (e) => {
    e.preventDefault();
    if (name2.value === "" || name2.value.length < 8) {
    ...
    register(name2.value, email.value, password.value).then(() => {
      window.location.hash = "#feed";
    }).catch((error) => {
...
async function newPost(textpost) {
  ...
  await nf(Xa(db, "posts"), createPosts);
}
const getUserData = () => {
...
async function findPosts(showPosts) {
  const queryOrder = al(Xa(db, "posts"), ml("date", "desc"));
  sf(queryOrder, (querySnapshot) => {
    const posts = [];
...
async function getPostById(postId) {
  const postRef = eh(db, "posts", postId);
...
const deletePost = async (postId) => ef(eh(db, "posts", postId));
const trash = "/assets/trash-can-regular.86b6816a.png";
const userIcon = "/assets/user-icon.65992588.png";
const heartEmpty = "/assets/heart-regular.4a9eb193.png";
...
const logoLinkedIn = "data:image/png;base64,";
const bruna = "/assets/bruna.765d051b.png";
const marina = "/assets/marina.9c0d41e2.png";
const silver = "/assets/silver.35649a0c.png";
const about = () => {
  ...
  <div class="about-container">
    <div class="about-we">
        ...
        <div class="dev">
            ...
            <p class="dev-bio">Com o sonho de fazer interc\xE2mbio, Bruna sempre buscou aprimorar 
            o ingl\xEAs e, quando surgiu a oportunidade de morar em Malta e na Inglaterra entre 
        ...
        <div class="dev">
            <img src="${marina}" class="dev-pic" alt="pic of Marina Cez\xE1rio">
            <h2 class="dev-name">Marina Cez\xE1rio</h2>
            <p class="dev-bio">Estudando Ingl\xEAs desde crian\xE7a, Marina sempre teve contato 
            com o idioma. Foi Au Pair entre 2011 e 2012, e, quando retornou ao Brasil, teve 
            a oportunidade de atuar como professora de Ingl\xEAs. Acredita no acesso do Ingl\xEAs 
        ...
        <div class="dev">
            ...
            <p class="dev-bio"> Silver \xE9 autodidata. Come\xE7ou a aprender ingl\xEAs com 12 anos 
            por meio da m\xFAsica e foi aprimorando o idioma usando as redes sociais em 
            intera\xE7\xF5es com outros usu\xE1rios. Hoje \xE9 professora de Ingl\xEAs e deseja que o S2S 
...
const faq = () => {
  ...
  <div class="faq-container">
    ...
    <div class="questions">
      ...
      <p>Na S2S, voc\xEA encontrar\xE1 todos os assuntos, temas e t\xF3picos relacionados \xE0 l\xEDngua inglesa,
      al\xE9m da troca de experi\xEAncias e intera\xE7\xF5es com pessoas que tamb\xE9m se identificam com o assunto.
      Dessa maneira todes poder\xE3o aprender, praticar e melhorar o Ingl\xEAs.</p>
      <h2>Como fazer o cadastro?</h3>
      <p>Na p\xE1gina inicial clique em "sign in" e ir\xE1 abrir a p\xE1gina para fazer o login. Nessa p\xE1gina, 
      ter\xE1 a op\xE7\xE3o "Click here if you still don't have an account" ("Clique aqui se voc\xEA ainda n\xE3o tem
      uma conta"), que ir\xE1 abrir a p\xE1gina para fazer o cadastro. Insira todos os dados solicitados
      na tela e dessa forma seu cadastro ser\xE1 conclu\xEDdo com sucesso.</p>
      <h2>Se eu j\xE1 tenho uma conta, como prosseguir?</h4>
      <p>Se voc\xEA j\xE1 tiver uma conta, basta clicar em "sign in" e inserir os dados para fazer o login.
      Dessa forma voc\xEA ser\xE1 redirecionado diretamente para a p\xE1gina do feed.</p>
      <h2>\xC9 poss\xEDvel fazer o login pela minha conta do Google?</h5>
      <p>Sim! Basta voc\xEA entrar em "sign in" e ver\xE1 a op\xE7\xE3o "Sign in with Google"("Login com Google")
      e assim o login ser\xE1 a feito atrav\xE9s da sua conta do Google/Gmail e voc\xEA ser\xE1 redirecionado para a 
      p\xE1gina do feed.</p>
      <h2>O que podemos fazer no S2S?</h2>
      <p>A ideia \xE9 que aqui, voc\xEA possa dar dicar e sugest\xF5es sobre e em Ingl\xEAs. Em nosso projeto futuro,
...
const init = () => {
  window.addEventListener("hashchange", () => {
    ...
    switch (window.location.hash) {
      case "#home":
        main$1.appendChild(headerInitial());
        main$1.appendChild(home());
        main$1.appendChild(footer());
        break;
      case "#login":
        main$1.appendChild(headerLogin());
        main$1.appendChild(login());
        main$1.appendChild(footer());
        break;
      case "#signup":
        main$1.appendChild(headerInitial());
        main$1.appendChild(signUp());
        main$1.appendChild(footer());
        break;
      case "#about":
        isUserLogged((user) => {
          if (user) {
            main$1.appendChild(headerFeed());
            main$1.appendChild(about());
          } else {
            main$1.appendChild(headerInitial());
            main$1.appendChild(home());
            main$1.appendChild(footer());
